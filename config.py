...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyB3MV8ybHFpzZas392yteynoG7Sq2bXPYI")
WEATHER_API_KEY = os.getenv("WEATHER_API_KEY", "af1cc0aca29045916c724521bd062a13")
